...
import shoesimg2 from '../assets/images/shoesimg2.png'
...
const Cardshoe = () => {
    const list = shoecards.map((shoecards) => (
        <Col xxl={3} xl={4} lg={4} md={6}  className='mt-3'>
            {/* <Card className='shoecards position-relative z-1 overflow-hidden'>
                <img src={shoecards.image} alt="img-1" className='w-100' />
                <div className='pe-2 ps-2 pt-4'>
                    <div className='d-flex align-content-center justify-content-between '>
                        <div>
                            <Card.Title className='ff-poppins fw-medium  lh-188  fs-sm color-grey mb-0 text-nowrap '>{shoecards.heading}</Card.Title>
                            <div className='d-flex gap-1 '>
                                <Card.Title className='ff-poppins fw-medium fs-sm color-offwhite pt-3 lh-188  mb-0'>{shoecards.para}</Card.Title>
                                <Card.Title className='ff-poppins fw-medium fs-sm color-red pt-3 lh-188  mb-0'>{shoecards.paragraph}</Card.Title>
                            </div>
                        </div>
                        <span>
                ...
                <div class="text-box d-flex align-items-center justify-content-center">
                    <p class="ff-poppins color-white fs-xs fw-light lh-242 mb-0">-10% OFF</p>
                </div>
                <div class="new-box">
                    <p class="ff-poppins color-white fs-xs fw-normal lh-242 mb-0">NEW</p>
                </div>
            </Card > */}
            <Card className="shoecards position-relative z-1 overflow-hidden br-20">
