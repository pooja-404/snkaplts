...
function Footersec() {
    return (
        <div>
            <footer className='dark-black'>
                <Container>
                    <Row className='py-4 '>
                        <Col lg={5} className=' pt-4 pt-xl-0'>
                            <img src={footerimg} alt="footer" className='cursor-pointer' />
                ...
                <div class="browm py-3 mt-5">
                    <p class="ff-poppins fw-normal color-white fs-sm lh-150 text-nowrap  text-center op-7 mb-0">© Copyright SNKRPLTS 2021.
                    </p>
                </div>
